...
const UserBox = ({userData}) => {
  ...
  const handleLogOut = async () => {
    ...
    if(response.toLowerCase().includes("success")){
      // setIsLoggedIn(false)
      notify2("Logged Out Successfully !!")
    }
  }
        ...
        <div className="widget-content p-0">
          <div className="widget-content-wrapper">
              ...
              <UncontrolledButtonDropdown>
                ...
                <DropdownMenu end className="rm-pointers dropdown-menu-lg">
                      ...
                      <div className="menu-header-content text-start">
                        <div className="widget-content p-0">
                          <div className="widget-content-wrapper">
                            ...
                            <div className="widget-content-left">
                              <div className="widget-heading">{userData?.name ?? "New User" }</div>
                              <div className="widget-subheading opacity-8">A short profile description</div>
                            </div>
                            <div className="widget-content-right me-2">
                              <Button className="btn-pill btn-shadow btn-shine" color="focus" onClick={handleLogOut}>Logout</Button>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="scroll-area-xs" style={{ height: "150px" }}>
                    <PerfectScrollbar>
                      <Nav vertical>
                        ...
                        <NavItem>
                          <NavLink href="#">Chat <div className="ms-auto badge rounded-pill bg-info">8</div></NavLink>
                        </NavItem>
                        <NavItem>
                        ...
                        <NavItem>
                          <NavLink href="#">Settings <div className="ms-auto badge bg-success">New</div></NavLink>
                        </NavItem>
                        <NavItem>
                          <NavLink href="#">Messages <div className="ms-auto badge bg-warning">512</div></NavLink>
                        </NavItem>
                        <NavItem>
                  ...
                  <div className="grid-menu grid-menu-2col">
                    <Row className="g-0">
                      <Col sm="6">
                        <Button className="btn-icon-vertical btn-transition btn-transition-alt pt-2 pb-2" outline color="warning">
                          <i className="pe-7s-chat icon-gradient bg-amy-crisp btn-icon-wrapper mb-2"> </i>
                          Message Inbox
                        </Button>
                      </Col>
                      <Col sm="6">
                        <Button className="btn-icon-vertical btn-transition btn-transition-alt pt-2 pb-2" outline color="danger">
                  ...
                  <Nav vertical>
                    ...
                    <NavItem className="nav-item-btn text-center">
                      <Button size="sm" className="btn-wide" color="primary">Open Messages</Button>
                    </NavItem>
                  </Nav>
                </DropdownMenu>
              </UncontrolledButtonDropdown>
            ...
            <div className="widget-content-left ms-3 header-user-info">
              <div className="widget-heading">{userData?.name ?? "New User" }</div>
              <div className="widget-subheading">ID: {userData?.id ?? "500001" }</div>
            </div>
            <div className="widget-content-right header-user-info ms-3">
              <Button className="btn-shadow p-1" size="sm" onClick={()=>notify2("Dummy Toast")} color="info" id="Tooltip-1">
